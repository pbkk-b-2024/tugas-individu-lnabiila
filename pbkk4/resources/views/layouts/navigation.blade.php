<header class="py-4 px-4 md:px-8 bg-white shadow-md">
    <div class="container mx-auto flex items-center justify-between">
        <!-- Brand / Logo -->
        <h1 class="text-2xl font-bold text-pink-500 md:text-3xl">Sepharo</h1>

        <!-- Search Form -->
        <form class="flex items-center ml-2">
            <div class="relative">
                <input class="form-control form-control-navbar px-3 py-1 border rounded-lg shadow-sm focus:outline-none focus:ring focus:border-pink-500" type="search" placeholder="Search item" aria-label="Search">
                <i class="fas fa-search absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500"></i>
            </div>
            <button class="btn btn-navbar ml-2 px-3 py-1 bg-pink-500 text-white rounded-lg" type="submit">
                Search
            </button>
        </form>
        ...
        <div class="flex items-center space-x-4">
            ...
            <div class="relative md:hidden">
                ...
                <div id="menu" class="hidden absolute right-0 mt-2 w-48 bg-white shadow-lg rounded-md z-50">
                    <a href="{{ route('category.index') }}" class="block px-4 py-2 text-black hover:bg-gray-100">Categories</a>
                    <a href="/menu" class="block px-4 py-2 text-black hover:bg-gray-100">Brands</a>
                    <a href="/contact" class="block px-4 py-2 text-black hover:bg-gray-100">Cart</a>
            ...
            <nav class="hidden md:flex space-x-4">
                <a href="{{ route('category.index') }}" class="text-black hover:text-pink-500">Categories</a>
                <a href="/menu" class="text-black hover:text-pink-500">Brands</a>
                <a href="/contact" class="text-black hover:text-pink-500">Cart</a>
            </nav>
