            ...
            <div id="controls-carousel" class="relative w-full" data-carousel="static">
                <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
                    ...
                    <div class="hidden duration-700 ease-in-out" data-carousel-item>
                        <img src="{{asset('storage/photo/'.$menu->photo)}}" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                    </div>
                    @endforeach
                </div>
        ...
        <div class="w-4/5">
            ...
            <div class="w-full p-4" style="margin-bottom: 10px">
                <div class="bg-white shadow-lg rounded-lg p-4 mb-8" style="display: flex; flex-direction: column; overflow: hidden;">
                    <h2 class="font-semibold text-lg text-gray-800 leading-tight mb-2 p-4">{{$activepromo->name}}</h2>
                        ...
                        <div class="lg:w-1/4 md:w-1/3 sm:w-full p-4">
                            <div class=" bg-white shadow-lg rounded-lg p-4" style="display: flex; flex-direction: column; height: 240px; overflow: hidden;">
                                <div class="flex" style="height: 100%; overflow: hidden;">
                                    <img src="{{asset('storage/photo/'.$activepromomenu->menu->photo)}}" class="w-full h-auto object-cover rounded-lg" style="max-height: 100%;">
                                </div>
