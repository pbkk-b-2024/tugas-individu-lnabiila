        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('outlet')" :active="request()->routeIs('outlet')">
                        {{ __('Outlet') }}
                    </x-nav-link>
                    @if(Auth::check() && Auth::user()->role == 'admin')
        ...
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')">
                {{ __('Dashboard') }}
                    ...
                    @if(Auth::check() && Auth::user()->role == 'admin')
                    <x-responsive-nav-link :href="route('type')" :active="request()->routeIs('type')">
                        {{ __('Type') }}
                    </x-responsive-nav-link>
                    @endif
                    ...
                    <x-responsive-nav-link :href="route('outlet')" :active="request()->routeIs('outlet')">
                        {{ __('Outlet') }}
                    </x-responsive-nav-link>
                    @if(Auth::check() && Auth::user()->role == 'admin')
